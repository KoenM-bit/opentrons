...
def build_arg_parser():
    ...
    arg_parser.add_argument('-d', '--save_to_drive', type=bool, required=False, help='Save results to drive?', default=1)
    return arg_parser
...
if __name__ == '__main__':
    ...
    if args.test:
        ...
        for labware in range(num_labware):
            ...
            if args.save_to_drive:
                google_drive_helper.upload_tof_files(drive_details, args.axis_name, f"Labware {labware}")
